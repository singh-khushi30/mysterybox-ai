      ...
      >
        <div className="flex min-h-48 items-end bg-[#cbb89a] p-5 text-[#2d2118]">
          <div>
            ...
            <p className="mt-2 font-display text-3xl">{evidence.imageLabel}</p>
          </div>
        </div>
        <div className="p-6">
          ...
          <h2 className="mt-2 font-display text-3xl text-paper">{evidence.title}</h2>
          <p className="mt-4 leading-7 text-beige/75">{evidence.description}</p>
          <dl className="mt-5 space-y-2 font-mono text-[0.68rem] tracking-[0.12em] text-beige/60 uppercase">
            ...
            <div className="flex justify-between gap-4 border-b border-brass/10 py-2">
              ...
              <dd className="text-right">{evidence.location}</dd>
            </div>
